...
public class TrainingController {
    ...
    public AddTrainingDTO addTraining(
            @RequestBody AddTrainingDTO addTrainingDTO
    ) {
    ...
    @PreAuthorize("hasAuthority('admin')")
    public AddTrainingDTO updateTraining(@RequestBody AddTrainingDTO addTrainingDTO, @PathVariable Long idTraining) {
    ...
    @PreAuthorize("hasAuthority('admin')")
    public TrainingDTO updateStatus(@PathVariable Long idTraining, @RequestBody TrainingDTO trainingDTO) {
        return trainingService.updateStatus(idTraining, trainingDTO, trainingDTO.getStatus().toString());
    }
    ...
    @PreAuthorize("hasAuthority('admin')")
    public TrainingDTO removePv(
            @PathVariable Long idTraining,
            @RequestBody TrainingDTO trainingDTO) {
        return trainingService.removePv(idTraining, trainingDTO);
    }

    @PutMapping(value = {"/add/trainingSupport/{idTraining}"}, consumes = {MediaType.MULTIPART_FORM_DATA_VALUE})
    @PreAuthorize("hasAuthority('admin')")
